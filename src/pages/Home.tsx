...
const LS_KEY = 'madhuratex_customer_reviews'
const LEGACY_LS_KEY = 'sreeja_bridal_customer_reviews'
function lsGetReviews(): CustomerReview[] {
  try { return JSON.parse(localStorage.getItem(LS_KEY) || localStorage.getItem(LEGACY_LS_KEY) || '[]') } catch { return [] }
}
