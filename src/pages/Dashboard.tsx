...
export default function Dashboard() {
  ...
  return (
    <div className="admin-shell h-screen max-h-screen min-h-screen bg-bgMain flex flex-col lg:flex-row overflow-hidden">
      ...
      <aside
        className={[
          'w-full bg-[#0B2559] text-white border-b lg:border-b-0 lg:border-r border-[#D4AF37]/30 flex flex-col shrink-0 h-auto lg:h-full lg:max-h-screen',
      ...
      >
        ...
        <div className={`hidden lg:flex items-center relative transition-all duration-300 shrink-0 ${sidebarCollapsed ? 'flex-col items-center pt-4 pb-3 px-2 gap-2' : 'px-4 py-3.5 justify-between border-b border-white/10'}`}>
          <Link to="/pos" title="Go to Billing Panel" className={`flex items-center gap-2.5 min-w-0 transition-all duration-300 ${sidebarCollapsed ? 'justify-center' : 'flex-1'}`}>
            <div className="flex items-center justify-center shrink-0 w-9 h-9 rounded-xl bg-[#081C44] border border-[#D4AF37]/60 shadow-sm hover:scale-105 transition-transform p-0.5 overflow-hidden">
            ...
            {!sidebarCollapsed && (
              <div className="flex flex-col min-w-0">
                ...
                <span className={`text-[8.5px] font-black uppercase tracking-widest px-1.5 py-0.2 rounded w-fit ${role === 'admin' ? 'bg-[#D4AF37]/20 text-[#D4AF37] border border-[#D4AF37]/40' : 'bg-white/10 text-gray-200 border border-white/20'}`}>
          ...
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/10 text-white/80 hover:bg-white/20 hover:text-white transition-colors shrink-0 cursor-pointer"
        ...
        {/* Mobile mini-header */}
        <div className="flex lg:hidden items-center justify-between px-3 py-2 border-b border-white/10 bg-[#0B2559] shrink-0 gap-2">
          <Link to="/pos" title="Go to Billing Panel" className="flex items-center gap-2 min-w-0 flex-1 overflow-hidden">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#081C44] border border-[#D4AF37]/60 shrink-0 shadow-sm hover:scale-105 transition-transform p-0.5 overflow-hidden">
              <img src={BRAND_ICON} alt={BRAND_EN} className="w-full h-full object-contain" />
            </div>
            <div className="flex items-center gap-1.5 min-w-0 flex-1 overflow-hidden">
              ...
              <span className={`shrink-0 text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded whitespace-nowrap ${role === 'admin' ? 'bg-[#D4AF37]/20 text-[#D4AF37] border border-[#D4AF37]/40' : 'bg-white/10 text-gray-200 border border-white/20'}`}>
                {role === 'admin' ? 'ADMIN' : 'STAFF'}
              </span>
            </div>
          </Link>
          ...
          {navItems.map(item => (
            <button
              ...
              className={[
                ...
                tab === item.id ? 'bg-[#123E94] text-[#D4AF37] font-black border border-[#D4AF37]/40 shadow-md' : 'text-white/80 hover:bg-white/10 hover:text-[#D4AF37]',
              ].join(' ')}
            >
