                    ...
                    <div className="p-3 bg-amber-50/70 border border-amber-200 rounded-xl space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md bg-[#0B2559] text-[#D4AF37] border border-[#D4AF37] text-[10px] font-black uppercase tracking-wider hover:bg-[#123E94] transition-all flex items-center gap-1 cursor-pointer shadow-xs"
                        >
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              <label className="flex items-center gap-1.5 mr-2 cursor-pointer" title="Check this to automatically increase stock by the number of labels printed.">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border-gray-300 text-[#0B2559] focus:ring-[#0A0A0A] cursor-pointer"
                />
