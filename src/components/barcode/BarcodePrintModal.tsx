      ...
      <div className="relative z-10 bg-white rounded-none sm:rounded-3xl max-w-2xl sm:max-w-3xl w-full h-screen h-[100dvh] sm:h-auto sm:max-h-[92vh] border-0 sm:border border-[#E2E8F0] shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-150">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-4 overflow-y-auto flex-1 min-h-0">
          ...
          <div className="bg-[#FBFAF6] border border-[#E2E8F0] rounded-2xl p-3.5 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-black text-[#0B2559] leading-tight">{productName}</h3>
              {variantName && (
          ...
          <div className="bg-[#FBFAF6] border border-[#E2E8F0]/70 rounded-2xl p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-1.5 p-1 rounded-xl bg-white border border-[#E2E8F0] shadow-sm">
                  <button
                    type="button"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full py-2.5 px-3 rounded-xl border-2 border-[#E2E8F0] bg-white font-bold text-xs sm:text-sm text-gray-900 outline-none focus:border-[#0B2559] shadow-sm cursor-pointer"
                >
                  {presets.map((p) => (
            ...
            <div className="pt-3 border-t border-[#E2E8F0]/50">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="inline-flex items-center rounded-xl border-2 border-[#E2E8F0] bg-white overflow-hidden shadow-sm shrink-0">
                  <button
                    type="button"
          ...
          <div>
            ...
            <div className="bg-[#FBFAF6] border-2 border-dashed border-[#E2E8F0] rounded-2xl py-6 px-4 flex items-center justify-center min-h-[140px]">
              <BarcodeLabel
        ...
        <div className="bg-[#FBFAF6] px-4 py-3 sm:px-6 sm:py-3.5 border-t border-[#E2E8F0] flex items-center justify-between shrink-0 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] gap-2">
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="flex items-center gap-1.5 sm:gap-2 px-4 py-2 sm:px-6 sm:py-2.5 rounded-xl bg-[#0B2559] border border-[#D4AF37] text-[#D4AF37] font-black hover:bg-[#123E94] transition-all shadow-md cursor-pointer hover:scale-[1.02] text-xs sm:text-sm shrink-0"
          >
            <Printer size={16} />
