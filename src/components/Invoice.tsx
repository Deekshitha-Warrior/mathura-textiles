...
export const Invoice: React.FC<InvoiceProps> = ({
  ...
  return (
    <div
      ...
      className="w-full max-w-[680px] mx-auto bg-white text-[#0F172A] box-border flex flex-col p-4 sm:p-8 print:p-0 print:max-w-full overflow-hidden border border-[#E2E8F0] shadow-xl rounded-3xl print:min-h-[290mm]"
      style={{
        fontFamily: "'Inter', 'Segoe UI', sans-serif",
      }}
    >
      {/* ── HEADER ────────────────────────────────────────────────── */}
      <div className="invoice-header" style={{ textAlign: 'center', borderBottom: '1px solid #E2E8F0', paddingBottom: 20, marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 10.5, fontWeight: 700, color: '#B38018', letterSpacing: 1, textTransform: 'uppercase', marginTop: 2 }}>
          Premium Wholesale Store ("Our Suit, Your Style")
        </div>
        <div style={{ fontSize: 11, color: '#475569', marginTop: 4, fontWeight: 500, paddingLeft: 8, paddingRight: 8 }}>
          {BRAND_ADDRESS}
        </div>
        <div style={{ fontSize: 11, color: '#475569', marginTop: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
      ...
      <div className="invoice-meta grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div style={{ minWidth: 0, padding: '12px 14px', borderRadius: 12, background: '#F8FAFC', border: '1px solid #E2E8F0' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 900, color: '#0B2559' }}>#{formattedInvoiceNo}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
        ...
        <div style={{ minWidth: 0, padding: '12px 14px', borderRadius: 12, background: '#F8FAFC', border: '1px solid #E2E8F0', overflowWrap: 'anywhere' }}>
          ...
          <div style={{ fontSize: 13, fontWeight: 800, color: '#0F172A', lineHeight: 1.35, wordBreak: 'break-word' }}>{customerName || 'Walk-in Customer'}</div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <div style={{ minWidth: 240, width: '100%', maxWidth: 300 }}>
            ...
            >
              ...
              <span style={{ fontSize: 20, fontWeight: 900, color: '#0B2559', fontVariantNumeric: 'tabular-nums' }}>{formatCurrency(total)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div style={{ fontSize: 12, fontWeight: 800, color: '#0B2559', letterSpacing: 0.5 }}>
