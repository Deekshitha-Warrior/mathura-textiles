...
export default function AddProductModal({ isOpen, onClose, onSuccess }: AddProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl w-full max-w-md flex flex-col shadow-2xl overflow-hidden border border-[#E2E8F0] animate-in fade-in zoom-in-95 duration-200">

        <div className="flex items-center justify-between p-6 border-b border-[#D4AF37]/30 bg-[#0B2559] text-white">
          <div>
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-black"
          ...
          <div className="grid grid-cols-2 gap-3">
              ...
              {categoryMode === 'select' ? (
                <div className="flex gap-1">
                  ...
                  <button
                    ...
                    className="px-2.5 py-3 text-xs font-black text-[#0B2559] bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl hover:bg-amber-100 transition-colors shrink-0"
                ...
                <div className="flex gap-1">
                  <input
                    ...
                    value={formData.category}
                    onChange={e => setFormData({...formData, category: e.target.value})}
                    className="flex-1 w-full px-3 py-3 bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-xs font-bold text-black"
                    placeholder="Type Category"
                  />
                  <button
                    type="button"
                    onClick={() => { setCategoryMode('select'); setFormData(f => ({...f, category: ''})) }}
                    className="px-2.5 py-3 text-xs font-black text-gray-700 bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl hover:bg-gray-200 transition-colors shrink-0"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-right text-black"
                placeholder="0"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-[#FBFAF6] border-2 border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-black"
                placeholder="5"
              />
            </div>
          </div>

          <div className="bg-[#FBFAF6] border border-[#E2E8F0] p-3 rounded-xl text-[11px] text-gray-600 flex items-start gap-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full py-3.5 bg-[#0B2559] border border-[#D4AF37] hover:bg-[#123E94] text-[#D4AF37] rounded-xl text-xs font-black tracking-wider transition-all disabled:opacity-50 shadow-md cursor-pointer"
          >
