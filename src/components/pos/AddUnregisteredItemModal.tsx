...
export const AddUnregisteredItemModal: React.FC<Props> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
      <div className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] flex flex-col shadow-2xl overflow-hidden border border-[#E2E8F0]/50 animate-in fade-in zoom-in-95">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-3.5 overflow-y-auto flex-1 text-xs">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-[#FBFAF6] border border-gray-200 rounded-xl text-xs font-semibold text-[#111111] focus:outline-none focus:border-[#0B2559] focus:bg-white transition-colors"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full px-3 py-2 bg-[#FBFAF6] border border-gray-200 rounded-xl text-xs font-bold text-[#111111] focus:outline-none focus:border-[#0B2559] focus:bg-white transition-colors"
              />
            </div>
            <div>
              <label className="block font-bold text-[#374151] mb-1">
          ...
          <div className="pt-2 flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="h-8 px-3.5 text-[11px] font-bold rounded-lg bg-[#0B2559] text-[#D4AF37] border border-[#D4AF37] hover:bg-[#123E94] transition-all shadow-xs disabled:opacity-50 flex items-center gap-1.5 cursor-pointer"
            >
              {isSubmitting ? (
                <>
